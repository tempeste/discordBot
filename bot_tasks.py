...
async def update_bot_status(client):
    _, cpu_usage, mem_usage, server_status = await cobbleverse_utils.check_cobbleverse_server()
    status_message = f"Cobbleverse - CPU: {cpu_usage}, Memory: {mem_usage}, Status: {server_status}"
